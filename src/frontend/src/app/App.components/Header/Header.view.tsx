    ...
    <>
      <div className='header'>
        ...
        <div className='header-menu'>
          <div className='header-menu-list'>
            <button className='header-menu-list__item btn'
                    onClick={() => setIsDropdownOpen(!isDropdownOpen)}>Academy <span>&#9660;</span></button>
          ...
          <div className='header-menu-cred'>
            {!user ? loggedInHeader() : loggedOutHeader()}
          </div>
          <div className={`header-menu__burger-icon ${isBurgerMenuOpen ? 'header-menu__exit-icon' : ''}`}
               onClick={() => {
        ...
        <div className={`header-chapters p-font ${isDropdownOpen ? '' : 'hidden'}`}>
          ...
          <span className='header-chapters__item__name'>Chapter 1: <span
            className='h-font'>What will this course cover?</span></span>
            <div className='header-chapters__item__completion completed'>COMPLETED</div>
          </Link>
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 2: <span
            className='h-font'>What are Contracts?</span></span>
            <div className='header-chapters__item__completion completed'>COMPLETED</div>
          </div>
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 3:
          ...
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 4: <span
            className='h-font'>Blockchain Introduction</span></span>
            <div className='header-chapters__item__completion'></div>
          </div>
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 5: <span
            className='h-font'>How Blockchains Work Intro</span></span>
            <div className='header-chapters__item__completion'></div>
          </div>
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 6: <span
            className='h-font'>Smart Contracts - The Future</span></span>
            <div className='header-chapters__item__completion '></div>
          </div>
          <div className='header-chapters__item'>
          <span className='header-chapters__item__name'>Chapter 7:
            <span className='h-font'>The Smart Contract Connectivity Problem</span>
          </span>
            <div className='header-chapters__item__completion'></div>
          </div>
          <div className='header-chapters__item no-bb'>
          <span className='header-chapters__item__name'>Chapter 8: <span
            className='h-font'>Centralized Oracles</span></span>
            <div className='header-chapters__item__completion'></div>
          </div>
        </div>
        <div className={`header-list ${isBurgerMenuOpen ? '' : 'hidden'}`}>
          <div className='header__item-border' />
          <button className='header-list__item with-bt btn'
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}>Academy <span>&#9660;</span></button>
          <div className='header__item-border' />
          ...
          <div className='header__item-border' />
          <div className='header-dropdown-user-menu'>
            {!user ? loggedInHeader() : loggedOutHeader()}
          </div>
        </div>
      </div>
